...
#make -j32 redo-syn-ChipTop CONFIG=$CONFIG_TO_RUN VLSI_OBJ_DIR=$MY_BUILD_DIR HAMMER_EXTRA_ARGS="-p $THISDIR/specs/proj-design.yml"
#make -j32 redo-syn-to-par-ChipTop CONFIG=$CONFIG_TO_RUN VLSI_OBJ_DIR=$MY_BUILD_DIR HAMMER_EXTRA_ARGS="-p $THISDIR/specs/proj-design.yml"
